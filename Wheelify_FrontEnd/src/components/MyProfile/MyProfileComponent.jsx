...
const MyProfileComponent = () => {
    ...
    const fetchProfile = async () => {
      try {
        const response = await axios.get(
          "https://wheelify-backend.onrender.com/api/v1/get-profile-details",
          {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const response = await axios.delete("https://wheelify-backend.onrender.com/api/v1/delete-account", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        withCredentials: true,
