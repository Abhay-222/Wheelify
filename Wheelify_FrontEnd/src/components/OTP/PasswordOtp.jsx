...
const OtpPage = () => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await axios.post('https://wheelify-backend.onrender.com/api/v1/otp-verification-and-password-reset', {
        ...userData,
        otp,
      });
  ...
  const handleResendOTP = async () => {
    try {
      const response = await axios.post('https://wheelify-backend.onrender.com/api/v1/generate-otp', {
        name: userData.name,
