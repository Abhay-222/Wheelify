...
const RentalHistory = () => {
  ...
  const fetchHistory = async () => {
    try {
      const res = await axios.get("https://wheelify-backend.onrender.com/api/v1/get-rental-history", {
  ...
  const handleCancel = (bookingId) => handleAction(
    "https://wheelify-backend.onrender.com/api/v1/cancel-booking", 
    bookingId, 
  ...
  const handlePickup = (bookingId) => handleAction(
    "https://wheelify-backend.onrender.com/api/v1/mark-pickedup", 
    bookingId, 
  ...
  const handleDrop = (bookingId) => handleAction(
    "https://wheelify-backend.onrender.com/api/v1/mark-returned", 
    bookingId, 
  ...
  const handleRatingSubmit = async () => {
    ...
    try {
      const response = await axios.post(
        `https://wheelify-backend.onrender.com/api/v1/add-bike-rating/${bookingId}`,
