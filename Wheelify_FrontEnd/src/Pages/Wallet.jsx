...
const WalletPage = () => {
  ...
  const getApiEndpoint = (tabType) => {
    const endpoints = {
      "All": "https://wheelify-backend.onrender.com/api/v1/get-transaction-history",
      "Deposits": "https://wheelify-backend.onrender.com/api/v1/get-deposit-history",
      "Withdrawals": "https://wheelify-backend.onrender.com/api/v1/get-withdrawal-history",
      "Refunds": "https://wheelify-backend.onrender.com/api/v1/get-refund-history"
    };
  ...
  const fetchWalletData = async (tabType = "All", page = 1, reset = true) => {
    try {
      ...
      const [balanceRes, transactionRes] = await Promise.all([
        axios.get("https://wheelify-backend.onrender.com/api/v1/get-profile-details", {
  ...
  const handleDeposit = async () => {
    try {
      ...
      const res = await axios.post(
        "https://wheelify-backend.onrender.com/api/v1/deposit-money",
        {},
        {
          headers: {
  ...
  const handleWithdraw = async () => {
    try {
      ...
      const res = await axios.post(
        "https://wheelify-backend.onrender.com/api/v1/withdraw-money",
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
