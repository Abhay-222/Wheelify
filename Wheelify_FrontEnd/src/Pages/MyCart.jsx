...
const MyCart = () => {
  ...
  const fetchCart = async () => {
    try {
      const res = await axios.get("https://wheelify-backend.onrender.com/api/v1/get-cart-details", {
  ...
  const handleRemove = async (bookingMongoId) => {
    try {
      const res = await axios.post(
        "https://wheelify-backend.onrender.com/api/v1/remove-from-user-cart",
  ...
  const handleClearCart = async () => {
    try {
      const res = await axios.post(
        "https://wheelify-backend.onrender.com/api/v1/clear-user-cart",
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
          withCredentials: true,
  ...
  const handlePayment = async (booking) => {
    try {
      const res = await axios.post(
        "https://wheelify-backend.onrender.com/api/v1/add-to-history",
