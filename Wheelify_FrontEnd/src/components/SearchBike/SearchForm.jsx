...
const SearchForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Optional: you can collect input values if needed
  ...
  return (
    <section className="text-center py-16 bg-[#f0f9f4]">
      ...
      <form
        ...
        className="bg-white rounded-xl shadow-md p-8 w-full max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6"
      >
        <div>
